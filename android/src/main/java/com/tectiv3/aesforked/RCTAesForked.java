...
public class RCTAesForked extends ReactContextBaseJavaModule {
    ...
    @ReactMethod
    public void encrypt(String plainText, String key,String iv, Promise promise){
        try {
    ...
    @ReactMethod
    public void decrypt(String encryptedText, String key, String iv, Promise promise){
        try {
            CryptLib _crypt = new CryptLib();
